...
from model.estmm.attention_modules import Spatial_Attention
from model.estmm.attention_modules import Temporal_Attention


def create_estmm(args):
    return ESTMM(sequence_size=30)


class ESTMM(nn.Module):
